...
public class BatcUnBindCardTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatcUnBindCardTask.class);
    private AppHeader head = null;
    private UserRemoveBindCardReq req = null;

    public BatcUnBindCardTask(AppHeader head, UserRemoveBindCardReq req) {
        this.head = head;
    ...
    public void run() {
        ...
        //把报文转换成XML
        PUserRemoveBindCardClient recharge = new PUserRemoveBindCardClient();
        ...
        try {
            ...
            Logger.getLogger(BatcUnBindCardTask.class.getName()).log(Level.SEVERE, null, ex);
        }
