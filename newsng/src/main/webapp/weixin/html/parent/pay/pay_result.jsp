                    ...
                    <div class="weui-msg">
                        <div class="weui-msg__icon-area" id="tipIcon">
                            <c:if test="${result.success == true}">
                                <img class="tip-img" src="/newsng/weixin/images/pay_success.png" alt="">
                            </c:if>
                            <c:if test="${result.success == false}">
                                <img class="tip-img" src="/newsng/weixin/images/pay_error.png" alt="">
                            </c:if>
                        </div>
                            ...
                            <ul>
                                <li class="item-content">
                                    <div class="item-inner">
                                        ...
                                        <div class="item-after successTip_text" id="paymoney" >${result.data.money}</div>
                                    </div>
                                </li>
                                <li class="item-content">
                                    <div class="item-inner">
