...
<div class="pageContent">
	<form id="form" method="post" action="../role/rightadd" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<div style="clear: both; padding: 5px;">
				<label>权限名称：</label>
				<input name="right_name" id="right_name" class="required" type="text" size="30" value=""/>
				<span id="check_result"></span>
			</div>
			<div style="clear: both; padding: 5px;">
				<label>权限编码：</label>
				<input name="right_code" id="right_name" class="required" type="text" size="30" value=""/>
				<span id="check_result"></span>
			</div>
			<div style="clear: both; padding: 5px;">
				<label>权限备注：</label>
				<input name="right_note" type="text" size="30" value=""/>
			</div>
		</div>
		<div class="formBar">
			<ul>
