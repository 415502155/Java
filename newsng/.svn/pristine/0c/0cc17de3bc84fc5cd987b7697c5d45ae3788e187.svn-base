...
function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<font>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='http://dl.5tree.cn/CLodop_Setup_for_Win32NT.exe' target='_self' style='font-size:16px;padding:0 10px;color:#066dbd'>执行安装</a>,安装后请刷新页面。</font>";
    ...
    try{
            ...
            if (!LODOP) {
            	if (isIE) {
			 	//document.write(strCLodopInstall);
			 	    myTips("printTIps",1,strCLodopInstall,null) 
            	} else{
        ...
        LODOP.SET_LICENSES("","EAB139C26ADCEF085219A12AD2445770","C94CEE276DB2187AE6B65D56B3FC2848","");
        //===========================================================
        return LODOP;
