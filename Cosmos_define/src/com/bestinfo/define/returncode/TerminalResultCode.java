...
public class TerminalResultCode {
     ...
     * 流水号超过最大值
     */
    public static final int MAX_SERIAL_NO = 6022;
...
//    public static final int NO_BET_INFO = 6692;
    ...
    /**
     * 在游戏外加信息中根据game_id从缓存中没有查到游戏外加信息
     */
    public static final int noGameAddInfo = 4408;
    /**
     * 在编码描述信息中根据d2code_id从缓存中没有查到编码描述信息
     */
    public static final int noD2codeInfo = 4409;

    //中彩二维码key上传下载
    public static final int clpQrcodeKey = 4410;
    
    
     /*****微信支付错误码******/
    public static final int weChatPay_dataSwitchError = 9000;//数据转换错误
    public static final int weChatPay_dataSaveError = 9001;//数据入库保存错误
    public static final int weChatPay_commFail = 9002;//通信失败
    public static final int weChatPay_dataUpdateError = 9003;//数据更新错误
    public static final int weChatPay_composeDataError = 9004;//组装回复报文错误
    public static final int weChatPay_businessError = 9005;//微信连接失败 return_code=fail
    public static final int weChatPay_notPay = 9006;//未支付
    public static final int weChatPay_userPaying = 9007;//用户支付中,交易处理中
    public static final int weChatPay_PayError = 9008;//支付失败
    public static final int weChatPay_revoked = 9009;//支付已撤销
   // public static final int weChatPay_pending = 9010;//等待用户支付
    //public static final int weChatPay_inHand = 9011;//交易处理中

    //数据库中无该终端控制参数数据
    public static final int noTmnControlData = 3232;
}
