...
public class BatchAbstractQueryTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatchAbstractQueryTask.class);
    private AppHeader head = null;
    private AgentRechargeQueryReq req = null;

    public BatchAbstractQueryTask(AppHeader head, AgentRechargeQueryReq req) {
        this.head = head;
    ...
    public void run() {
        ...
        //把报文转换成XML
        PAgentAbstractQueryClient recharge = new PAgentAbstractQueryClient();
        ...
        try {
            ...
            Logger.getLogger(BatchAbstractQueryTask.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        logger.info("返回码:" + resultcode + "结果:" + tbrr.getAppResult().getResultDes());
    }
}
