 ...
 *
 */
public class BatchRechargeQueryTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatchRechargeQueryTask.class);
    private AppHeader head = null;
    private AgentRechargeQueryReq req = null;

    public BatchRechargeQueryTask(AppHeader head, AgentRechargeQueryReq req) {
        this.head = head;
        this.req = req;
    }
    ...
    public void run() {
        ...
        //把报文转换成XML
        PAgentRechargeQueryClient recharge = new PAgentRechargeQueryClient();
        ...
        try {
            ...
            Logger.getLogger(BatchRechargeQueryTask.class.getName()).log(Level.SEVERE, null, ex);
        }
