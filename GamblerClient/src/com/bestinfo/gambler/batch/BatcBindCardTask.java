...
public class BatcBindCardTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatcBindCardTask.class);
    private AppHeader head = null;
    private UserBindCardReq req = null;

    public BatcBindCardTask(AppHeader head, UserBindCardReq req) {
        this.head = head;
    ...
    public void run() {
        ...
        //把报文转换成XML
        PUserBindCardClient recharge = new PUserBindCardClient();
        ...
        try {
            ...
            Logger.getLogger(BatcBindCardTask.class.getName()).log(Level.SEVERE, null, ex);
        }
