 ...
 *
 */
public class BatchGamblerModifyTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatchGamblerModifyTask.class);
    private AppHeader head = null;
    private UserModifyInfoReg req = null;

    public BatchGamblerModifyTask(AppHeader head, UserModifyInfoReg req) {
        this.head = head;
        this.req = req;
    }
    ...
    public void run() {
        ...
        //把报文转换成XML
        PUserModifyInfoClient recharge = new PUserModifyInfoClient();
        ...
        try {
            ...
            Logger.getLogger(BatchGamblerModifyTask.class.getName()).log(Level.SEVERE, null, ex);
        }
