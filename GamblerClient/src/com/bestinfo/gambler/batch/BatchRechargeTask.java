 ...
 * 充值批处理任务
 */
public class BatchRechargeTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatchRechargeTask.class);
    private AppHeader head = null;
    private AgentRechargeUserReqList req = null;

    public BatchRechargeTask(AppHeader head, AgentRechargeUserReqList req) {
        this.head = head;
        this.req = req;
    }
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(BatchRechargeTask.class.getName()).log(Level.SEVERE, null, ex);
        }
