 ...
 * 
 */
public class JsonUtil implements PropertyFilter {
	 ...
	 *            忽略属性名称数组
	 */
	public JsonUtil(boolean ignoreColl, String[] fields) {
		this.fields = fields;
	 ...
	 *            是否忽略集合
	 */
	public JsonUtil(boolean ignoreColl) {
		this.ignoreColl = ignoreColl;
	}
