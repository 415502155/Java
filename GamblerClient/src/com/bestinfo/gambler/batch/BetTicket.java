 ...
 *
 */
public class BetTicket implements Callable<Object> {
    ...
    public BetTicket(PBetSchemeRequst reqBean, AppHeader head, Count c, int doNum) {
        this.req = reqBean;
        this.head = head;
        this.c = c;
        this.doNum = doNum;
    ...
    public Object call() throws Exception {
        return execTicketBet1(req, head, c, doNum);
    }
     ...
     */
    private int execTicketBet1(final PBetSchemeRequst tbr, final AppHeader head, final Count c, final int doNum) throws DecoderException {
        try {
