...
public enum GameblerResultCode {
    ...
    //运营商游戏期数据查询
    DealerGameDrawQuery_gameIdError(1801, "请填写游戏编号"),
    DealerGameDrawQuery_drawNameError(1802, "请填写期名（年期号）"),
    DealerGameDrawQuery_gameInfoError(1803, "游戏编号不存在"),
    DealerGameDrawQuery_resultError(1804, "运营商游戏期信息数据查询失败"),;
