...
//     封装移动端事件;滑动 左滑，右滑，上滑，下滑，双击，单击，长按
//     ['swipe', 'swipeLeft', 'swipeRight', 'swipeUp', 'swipeDown','doubleTap', 'tap', 'singleTap', 'longTap']
//     singletap和tap都是单击事件，它们有什么区别呢？
//     区别就是：
//     1、singletap 单击 和 doubletap双击 是对应的两个事件
//     2、如果只点击一次，触发顺序是 tap、singletap
//     3、如果连续点击两次，触发顺序则是tap、tap、doubletap
