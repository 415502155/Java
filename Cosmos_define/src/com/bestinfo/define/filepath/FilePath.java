...
//    public static String issuep;
    ...
    //快开中奖文件下载nginx标志名称
    public static String winNameK;
    //快开销售对账文件下载nginx标志名称
    public static String accountNameK;
    //快开中奖文件路径
    public static String winUrlK;
    //快开对账文件路径
    public static String accountUrlK;
    ...
    public static String dealer_jiqiren;//机器人

    public static String dealer_huaxia;//华夏

    public static String dealer_zhongyue;//中悦
...
//        sb.append(firstclass + System.getProperty("file.separator"));
    ...
    /**
     * 为了杉德传的 1005ACOM20160106.txt 文件增加一个子目录（不包括文件名，只有文件的相对路径）
     *
     * @param bankCode 银行编码（如：ICBC）
     * @return
     */
    public static String getPayInFilePath4Acom(String bankCode) {
        StringBuilder sb = new StringBuilder();
        sb.append(getRootPath());
        sb.append(bank).append(System.getProperty("file.separator"));
        sb.append("bank_").append(bankCode).append(System.getProperty("file.separator"));
        sb.append("acom").append(System.getProperty("file.separator"));
        return sb.toString();
    }
     ...
     * @return
     */
    public static String createKenoStatErrorFileName(String draw_name) {
        StringBuilder sb = new StringBuilder();
        sb.append(FilePath.rootLogPath).append(System.getProperty("file.separator"));
        sb.append(FilePath.KENO_LUCKY_LOG).append(System.getProperty("file.separator"));
        sb.append("luckyLog").append(System.getProperty("file.separator"));
        sb.append(draw_name).append(System.getProperty("file.separator"));
        sb.append("daystat_error");
        return sb.toString();
    }
...
//        sb.append(".xml");
     ...
     * @return
     */
    public static String getGamblerWinFileKeno(int gameId, int drawId, String dealerId, int kdrawId) {
        StringBuilder sb = new StringBuilder();
        sb.append(FilePath.rootPath).append(System.getProperty("file.separator"));
        sb.append(gambler).append(System.getProperty("file.separator"));
        sb.append(kenoFile).append(System.getProperty("file.separator"));
        sb.append(win).append(System.getProperty("file.separator"));
        sb.append(dealerId).append("_g").append(gameId);
        sb.append("_d").append(drawId);
        sb.append("_kd").append(kdrawId).append(".xml");
        return sb.toString();
    }
     ...
     * @return
     */
    public static String getGamblerAccountFileKeno(int gameId, int drawId, String dealerId, int kdrawId) {
        StringBuilder sb = new StringBuilder();
        sb.append(FilePath.rootPath).append(System.getProperty("file.separator"));
        sb.append(gambler).append(System.getProperty("file.separator"));
        sb.append(kenoFile).append(System.getProperty("file.separator"));
     ...
     * @return
     */
    public static String getClpFilePath(int gameId, String fileName) {
        StringBuilder sb = new StringBuilder();
        sb.append(FilePath.rootPath).append(System.getProperty("file.separator"));
        sb.append(FilePath.clpcenter).append(System.getProperty("file.separator"));
        sb.append("game").append(gameId).append(System.getProperty("file.separator"));
        sb.append(fileName);
        return sb.toString();
    }
     ...
     * @return
     */
    public static String getPadLogFilePath(String date, String fileName) {
        StringBuilder sb = new StringBuilder();
        sb.append(FilePath.rootPath).append(System.getProperty("file.separator"));
        sb.append(PAD_LOG).append(System.getProperty("file.separator"));
        sb.append(date).append(System.getProperty("file.separator"));
        sb.append(fileName);
        return sb.toString();
    }
     ...
     * @return
     */
    public static String getBurnCdFilePath(int gameId, String fileName) {
        StringBuilder sb = new StringBuilder();
        sb.append(FilePath.rootPath).append(System.getProperty("file.separator"));
        sb.append(FilePath.burncd).append(System.getProperty("file.separator"));
        sb.append("game").append(gameId).append(System.getProperty("file.separator"));
        sb.append(fileName);
        return sb.toString();
    }

    public static String getDayFile(String name, Date time, int week) {
        // Date now = new Date();
        StringBuilder sb = new StringBuilder();
        sb.append(FilePath.rootPath).append(System.getProperty("file.separator"));
        sb.append(dayfile).append(System.getProperty("file.separator"));
        sb.append(simple_formatter_8.format(time)).append(System.getProperty("file.separator"));
        if (name.equals("年计划")) {
            sb.append(name).append(simple_formatter_yyyy.format(time));
        } else if (name.equals("周销量")) {
            sb.append(name).append(simple_formatter_yyyy.format(time)).append("-").append(week);
        } else {
            sb.append(name).append(simple_formatter_date.format(time));
        }
        sb.append(".txt");
        return sb.toString();
    }
