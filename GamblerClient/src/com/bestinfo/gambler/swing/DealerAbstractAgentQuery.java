...
import com.bestinfo.gambler.batch.BatchAbstractQueryTask;
 ...
 * @author jone
 */
public class DealerAbstractAgentQuery extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DealerAbstractAgentQuery
     */
    public DealerAbstractAgentQuery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("                                  运营商代理提款查询");

        charge.setFont(new java.awt.Font("宋体", 0, 14)); // NOI18N
        charge.setText("0@2@55@66");
        ...
        jTextArea1.setText("提款类型：支付宝1，银行卡2，充值卡3，话费4，\n虚拟帐户5\n可以不填\n流水号自定标识最好为一位");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Phone2, javax.swing.GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(Phone3, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(terminal_id3, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            int actionID = ActionID.DEALER_AGENTABSTRACT_QUERY;
...
//        AgentAbstractUserInfo ar = new AgentAbstractUserInfo();
            ...
            req.setGamblerName(charge3.getText());
            req.setDealerSerial(charge.getText());

//         agentAbstractUsers.add(ar);
//         req.setAgentAbstractUsers(agentAbstractUsers);
            //把报文转换成XML
            PAgentAbstractQueryClient abstractQuery = new PAgentAbstractQueryClient();

            String requestxml = abstractQuery.generateXML(head, req);
...
//            byte[] ret_key = NewSign.GetSign(requestxml, "d:/gdclient.p12", "gdtest@2015", "cosmos", sessionKey);
            ...
            requestxml = abstractQuery.generateXML(head, req);
            ...
            //解析XML
            APPMessage ap = abstractQuery.parseXML(responsexml);
...
//        AgentAbstractUserInfo ar = new AgentAbstractUserInfo();
                    ...
                    TaskManager.getInstance().execute(new BatchAbstractQueryTask(head, req));
                }
                ...
                try {
                    //查询用户名列表
                    list = GamblerInfoDao.getGambInfo(sendtype.getText());
                } catch (Exception ex) {
                    java.util.logging.Logger.getLogger(UserLogin.class.getName()).log(Level.SEVERE, null, ex);
                }
...
//            req.setDealerSerial(charge.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DealerAbstractAgentQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
