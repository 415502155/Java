...
public class InsuranceContract {
    ...
    public void someOperation(){
        ...
        System.out.println("保险公司的名称为【"+this.companyName+"】");
        /***
         * 将时间转为yyyy-MM-dd HH:mm:ss
         */

        Date sdate = new Date(this.beginDate);
        Date edate = new Date(this.endDate);
        String startTime = CommonUtils.dateFormat(sdate, null);
        String endTime = CommonUtils.dateFormat(edate, null);
        System.out.println("保險開始時間：【"+startTime+"】");
        System.out.println("保險結束時間：【"+endTime+"】");
    }
