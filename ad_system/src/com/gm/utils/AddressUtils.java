...
public class AddressUtils {    
 ...
 public static String getAddresses(String ip)  throws UnsupportedEncodingException {  
	  ...
	  String  urlStr="http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=json&"+content;
	  String address="";
	  try {
			String jsonstr=HttpClientUtil.get(urlStr);
			JSONObject json=JSONObject.fromObject(jsonstr);
			if(json.containsKey("province")){
				address=json.getString("province");
			}else{
				// 这里调用pconline的接口  
