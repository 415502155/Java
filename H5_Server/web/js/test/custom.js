...
$(document).ready(function(){
  ...
  $("#nav > li > a").on('click',function(e){
      ...
      //左侧导航栏三角形的方向控制JS代码
      if($(this).find("span > i").attr("class") === "icon-chevron-right"){
           $("#nav > li > a > span > i").attr("class","icon-chevron-right");
          $(this).find("span > i").attr("class","icon-chevron-down");
      }else{
            $(this).find("span > i").attr("class","icon-chevron-right");
      }
