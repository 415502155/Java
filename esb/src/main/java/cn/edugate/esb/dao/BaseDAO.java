...
public interface BaseDAO<T> {
	...
	@Transactional(readOnly=true)
	public void queryData(Class<T> clazz,String associationPath, JoinType joinType,Paging<T> paging,Cols columns, Criterion criterion, Order... orders);
	...
	@Transactional(readOnly=true)
	public List<T> list(Class<T> clazz,String associationPath, JoinType joinType, Cols columns,Criterion criterion, Order... orders);
	...
	public static class DATABASE_SCHEMA {
		public static final String BASE = "edugate_base";
