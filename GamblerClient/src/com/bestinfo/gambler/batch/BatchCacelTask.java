 ...
 *
 */
public class BatchCacelTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatchCacelTask.class);
    private AppHeader head = null;
    private UserCancelReq req = null;

    public BatchCacelTask(AppHeader head, UserCancelReq req) {
        this.head = head;
    ...
    public void run() {
        ...
        //把报文转换成XML
        PUserCancelClient recharge = new PUserCancelClient();
        ...
        try {
            ...
            Logger.getLogger(BatchCacelTask.class.getName()).log(Level.SEVERE, null, ex);
        }
