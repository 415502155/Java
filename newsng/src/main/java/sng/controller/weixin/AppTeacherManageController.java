...
public class AppTeacherManageController extends BaseAction {
	...
	public void queryClassByTeacher(HttpServletRequest request, HttpServletResponse response, ParamObj paramObj)
			throws Exception {
	...
	public void queryStudentByClass(HttpServletRequest request, HttpServletResponse response, ParamObj paramObj)
			throws Exception {
	...
	public void queryTelNumByStudent(HttpServletRequest request, HttpServletResponse response, ParamObj paramObj)
			throws Exception {
