...
public class BatchQueryTask implements Runnable {
    ...
    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatchQueryTask.class);
    private AppHeader head = null;
    private UserQueryReq req = null;

    public BatchQueryTask(AppHeader head, UserQueryReq req) {
        this.head = head;
        this.req = req;
    }
    ...
    public void run() {
        ...
        //把报文转换成XML
        PUserInfoQueryClient recharge = new PUserInfoQueryClient();
        ...
        try {
            ...
            Logger.getLogger(BatchQueryTask.class.getName()).log(Level.SEVERE, null, ex);
        }
