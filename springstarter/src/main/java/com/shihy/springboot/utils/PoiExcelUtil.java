...
import com.shihy.springboot.excelpojo.ExcelColumn;
...
//                FileInputStream is = new FileInputStream(new File(path));
    ...
    @SuppressWarnings("deprecation")
	public static <T> void writeExcel(HttpServletResponse response, String fileName, String sheetName, List<T> dataList, Class<T> cls){
