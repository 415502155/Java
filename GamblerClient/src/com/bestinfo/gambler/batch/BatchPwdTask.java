 ...
 *
 */
public class BatchPwdTask implements Runnable {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BatchPwdTask.class);
    private AppHeader head = null;
    private UserModifyPwdReq req = null;

    public BatchPwdTask(AppHeader head, UserModifyPwdReq req) {
        this.head = head;
        this.req = req;
    }
    ...
    public void run() {
        ...
        //把报文转换成XML
        PUserModifyPwdClient recharge = new PUserModifyPwdClient();
        ...
        try {
            ...
            Logger.getLogger(BatchPwdTask.class.getName()).log(Level.SEVERE, null, ex);
        }
