...
public interface ClassService {
	...
	void updateClasssAndTeacher(Map<String, Object> reqMap, SessionInfo sessionInfo, List<Map<String, Object>> techList);
	/***
	 * 
	 ...
	 *  @param tuitionFee
	 */
	void joinClass(Map<String, Object> reqMap, SessionInfo sessionInfo, Integer orgId, String studName, Integer studId, Integer clasId, Integer clasType, String tuitionFee, Integer insertPayType);
	/***
	 * 
	...
	@SuppressWarnings("rawtypes")
	Map importClass(HttpSession session, SessionInfo sessionInfo, InputStream fin, Integer orgId, Integer termId, String suffix);

	@SuppressWarnings("rawtypes")
	Map importStudent(HttpSession session, SessionInfo sessionInfo, InputStream fin, Integer orgId, Integer termId, String suffix);
