...
public class StudentCard {
	...
	public String getHeadurl() {
		if (this.util!=null&&this.head!=null&&!"".equals(this.head)) {
			headurl = this.util.getPathByPicName(this.head);
		} 
		return headurl;
	}
	...
	private String oldclas_name;
	@Transient
	public String getOldclas_name() {
		return oldclas_name;
	}
	public void setOldclas_name(String oldclas_name) {
		this.oldclas_name = oldclas_name;
	}
}
