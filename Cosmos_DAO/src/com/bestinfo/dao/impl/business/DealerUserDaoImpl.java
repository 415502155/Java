...
public class DealerUserDaoImpl extends BaseDaoImpl implements IDealerUserDao {
    ...
    private static final String getDealerUserByOperatorId = "select user_name from t_dealer_user where operator_id = ?";
     private static final String Get_Dealer_By_User= "select * from t_dealer_user where user_name = ? ";
    ...
    public DealerUser getDealerUserByUserName(JdbcTemplate jdbcTemplate, String name) {
        return queryForObject(jdbcTemplate, Get_Dealer_By_User, new Object[]{name}, DealerUser.class);
    }
}
